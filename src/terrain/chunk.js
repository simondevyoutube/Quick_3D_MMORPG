...
export class Chunk {
	...
	setFromData(data) {
		...
		this.geometry.setAttribute('color', new THREE.Float32BufferAttribute(data.colours, 3));
		this.geometry.setAttribute('normal', new THREE.Float32BufferAttribute(data.normals, 3));
		this.geometry.setAttribute('coords', new THREE.Float32BufferAttribute(data.coords, 3));
		this.geometry.setAttribute('weights1', new THREE.Float32BufferAttribute(data.weights1, 4));
		this.geometry.setAttribute('weights2', new THREE.Float32BufferAttribute(data.weights2, 4));
