...
class LinearSpline {
    ...
    Get(t) {
        ...
        return this._lerp((t - this.points_[p1][0]) / (this.points_[p2][0] - this.points_[p1][0]), this.points_[p1][1], this.points_[p2][1]);
    }
}
class ParticleEmitter {
    ...
    CreateParticle_() {
        ...
        return {
            position: new THREE.Vector3((Math.random() * 2 - 1) * 4.0 + -44, (Math.random() * 2 - 1) * 4.0 + 0, (Math.random() * 2 - 1) * 4.0 + 12),
