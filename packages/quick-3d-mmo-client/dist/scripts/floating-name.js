...
const { EVENT_TYPES, CHARACTER_MODELS } = Object.assign(Object.assign({}, Constants), Defs);
class FloatingName extends Component {
    ...
    InitComponent() {
        this._RegisterHandler(EVENT_TYPES.LOAD_CHARACTER, (m) => { this.CreateSprite_(m); });
    ...
    CreateSprite_(msg) {
        ...
        const modelData = CHARACTER_MODELS[this.params_.desc.character.class];
...
;
export { FloatingName };
//# sourceMappingURL=floating-name.js.map