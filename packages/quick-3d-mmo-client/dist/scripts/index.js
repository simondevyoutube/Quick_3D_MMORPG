...
class FloatingName {
    ...
    Init_() {
        ...
        this.sprite_ = new THREE.Sprite(new THREE.SpriteMaterial({ map: map, color: 0xffffff }));
...
class AnimatedMesh {
    ...
    Load_() {
        ...
        loader.load(modelData.base, (fbx) => {
            ...
            this.manager_.load(modelData.animations.idle, (a) => { _OnLoad(STATE_TYPES.IDLE, a); });
            this.manager_.load(modelData.animations.walk, (a) => { _OnLoad(STATE_TYPES.WALK, a); });
            this.manager_.load(modelData.animations.run, (a) => { _OnLoad(STATE_TYPES.RUN, a); });
            this.manager_.load(modelData.animations.dance, (a) => { _OnLoad(STATE_TYPES.DANCE, a); });
...
class BasicCharacterController {
    ...
    _Init(params) {
        ...
        this.stateMachine_ = new CharacterFSM(new BasicCharacterControllerProxy(this.target_.animations_));
    }
    get IsLoaded() {
        return this.loaded_;
    }
    ...
    Update(timeInSeconds) {
        ...
        const frameDecceleration = new THREE.Vector3(velocity.x * this.decceleration_.x, velocity.y * this.decceleration_.y, velocity.z * this.decceleration_.z);
...
class BasicCharacterControllerInput {
    ...
    OnKeyDown_(event) {
        var _a;
        const activeElement = (_a = event === null || event === void 0 ? void 0 : event.currentTarget) === null || _a === void 0 ? void 0 : _a.activeElement;
...
class PlayerEntity {
    ...
    UpdateTransform(data) {
        ...
        const p = data[1];
        const q = data[2];
        this.controls_.SetTransform(new THREE.Vector3(...p), new THREE.Quaternion(...q));
    }
    Update(timeElapsed) {
    ...
    SendTransform_(timeElapsed) {
        ...
        if (this.updateTimer_ <= 0.0 && this.controls_.IsLoaded) {
            ...
            this.params_.socket.emit(EVENT_TYPES.WORLD_UPDATE, this.controls_.CreateTransformPacket());
        }
    }
}
;
class NetworkCharacterController {
    ...
    Destroy() {
        var _a, _b, _c, _d;
        (_b = (_a = this.name_) === null || _a === void 0 ? void 0 : _a.Destroy) === null || _b === void 0 ? void 0 : _b.call(_a);
        this.name_ = null;
        (_d = (_c = this.target_) === null || _c === void 0 ? void 0 : _c.Destroy) === null || _d === void 0 ? void 0 : _d.call(_c);
        this.target_ = null;
    }
    _Init(params) {
        this.params_ = params;
...
class NetworkEntity {
    ...
    Destroy() {
        var _a, _b;
        (_b = (_a = this.controller_) === null || _a === void 0 ? void 0 : _a.Destroy) === null || _b === void 0 ? void 0 : _b.call(_a);
    }
    Init_() {
    }
...
class Chatbox {
    ...
    Init_() {
        ...
        this.element_.addEventListener('keydown', (e) => this.OnKeyDown_(e), false);
    }
    OnKeyDown_(evt) {
        if (evt.keyCode === 13) {
            evt.preventDefault();
