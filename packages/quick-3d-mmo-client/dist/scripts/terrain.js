...
const { QT_MIN_CELL_SIZE, QT_MIN_CELL_RESOLUTION, PLANET_RADIUS, NOISE_PARAMS, HeightGenerator, Noise, } = Object.assign(Object.assign(Object.assign({}, aNoise), TerrainHeight), TerrainConstants);
class TerrainChunkManager extends Component {
    ...
    _UpdateVisibleChunks_Quadtree(target) {
        ...
        for (let k in difference) {
            ...
            newTerrainChunks[k] = {
                position: [xp, zp],
                chunk: this._CreateTerrainChunk(difference[k].group, difference[k].transform, offset, difference[k].size, QT_MIN_CELL_RESOLUTION),
            };
        }
