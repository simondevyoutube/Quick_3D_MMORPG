...
const { Noise, HeightGenerator } = Object.assign(Object.assign({}, TerrainHeight), aNoise);
class _TerrainBuilderThreadedWorker {
    ...
    Rebuild() {
        ...
        for (let i = 0, n = indices.length; i < n; i += 3) {
            ...
            for (let s = 0; s < 3; s++) {
                let total = (((_c = (_a = splats === null || splats === void 0 ? void 0 : splats[s]) === null || _a === void 0 ? void 0 : _a[(_b = typeValues === null || typeValues === void 0 ? void 0 : typeValues[0]) === null || _b === void 0 ? void 0 : _b.key]) === null || _c === void 0 ? void 0 : _c.strength) +
                    splats[s][typeValues === null || typeValues === void 0 ? void 0 : typeValues[1].key].strength +
...
//# sourceMappingURL=terrain-builder-threaded-worker.js.map